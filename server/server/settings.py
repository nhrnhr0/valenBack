...
SECRET_KEY = 'django-insecure-tjd3lys17*%=0w+wv#yqs4$_-o(=2-y*1)&235u=($6)$d)%nx'
...
TINYMCE_DEFAULT_CONFIG = {
    ...
    'plugins': 'link image preview codesample contextmenu table code lists fullscreen gallery',
